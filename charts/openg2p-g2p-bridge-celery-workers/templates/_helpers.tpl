...
*/}}
{{- define "g2p-bridge.podAnnotations" -}}
...
*/}}
{{- define "g2p-bridge.serviceAccountName" -}}
...
Common labels
*/}}
{{- define "g2p-bridge.labels" -}}
helm.sh/chart: {{ include "g2p-bridge.chart" . }}
{{ include "g2p-bridge.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "g2p-bridge.selectorLabels" -}}
app.kubernetes.io/name: {{ include "g2p-bridge.name" . }}
...
*/}}
{{- define "g2p-bridge.imagePullSecrets" -}}
